    ...
    <main>
        ...
        >
            ...
            <div class="!absolute right-0 bottom-0">
                <span
                    class="h-16 w-16 bg-primary text-white dark:text-black inline-flex items-center justify-center"
                >
            ...
            >
                ...
                <div class="flex">
                    ...
                    <div class="grid grid-cols-1 max-w-60 w-full">
                        <CardText
                            title="DAY 1 非公開日"
                            :subtitles="['2024/10/18']"
                            :subsubtitles="['(金・平)']"
                        />

                        <CardText
                            title="DAY 2 公開日"
                            :subtitles="['2024/10/19']"
                            :subsubtitles="['(土・休)']"
                        />

                        <CardText
                            title="TIME"
                            :subtitles="['9:30 - 15:30']"
                            no-margin-bottom
                        />
                    </div>
                    ...
                    <div class="grid grid-cols-1 max-w-60 w-full">
                        ...
                        <CardText
                            title="SNS"
                            :subtitles="['Twitter', 'Tiktok']"
                            :subsubsubtitles="['最新情報をチェック!']"
                        />
                    </div>
                </div>
            </div>
