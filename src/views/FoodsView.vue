    ...
    items: Array<{
        ...
        },
        {
            ...
            items: [
                {
                    title: "焼き小籠包",
                    longerTitle: "ノーマル小籠包　2個",
                    price: 300,
                },
                {
                    title: "焼き小籠包",
                    longerTitle: "野菜小籠包　2個",
                    extra: true,
                    price: 300,
                },
                {
        ...
        },
        {
            ...
            items: [
                ...
                {
                    title: "ディッピンドッツ",
                    longerTitle: "クッキー＆クリーム",
                    extra: true,
                    price: 300,
                },
                {
                    title: "ディッピンドッツ",
                    longerTitle: "ストロベリーチーズケーキ",
                    extra: true,
                    price: 300,
                },
            ],
        ...
        },
        {
            ...
            items: [
                ...
                {
                    title: "ベビーカステラ",
                    longerTitle: "チョコレート　5個",
                    extra: true,
                    price: 200,
                },
                {
                    title: "ベビーカステラ",
                    longerTitle: "カスタード　5個",
                    extra: true,
                    price: 200,
                },
            ],
        ...
        <div class="self-start justify-self-center max-w-lg w-full grid gap-3">
            ...
            <div v-for="(item, index) in data" :key="item.class" :class="{ 'mb-10': index !== data.length - 1 }">
                ...
                <div class="flex flex-col gap-4">
                    <FoodText v-for="food in item.items" :key="food.title" :title="food.title"
                        :longerTitle="food.longerTitle" :price="food.price"
